...
lab = Label(sp, text = "Downloading Speed", font=("Time new Roman", 30, "bold"),bg="Blue",fg="White")
...
lab = Label(sp, text = "Upload Speed", font=("Time new Roman", 30, "bold"),bg="Blue",fg="White")
